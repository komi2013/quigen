...
CREATE TABLE incorrect (
    id integer DEFAULT nextval('incorrect_id_seq'::regclass) NOT NULL,
    question_id integer NOT NULL,
...
--
-- Name: COLUMN question.private; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN question.private IS '0=public,1=private';
