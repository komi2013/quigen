...
<table>
  ...
  <tr><td class="quest_1 td_99_c"><a href="/htm/myprofile/#position">offline quiz</a></td> <td class="td_15_c" id="img_quest_1"><img src="/assets/img/icon/star_0.png"></td></tr>
...
<script>
  ...
  var light_2_msg = '<?=Config::get("lang.you_can_answer_after_this_time")?>';
  var answer_first = '<?=Config::get("lang.answer_first")?>';
  var no_point = '<?=Config::get("lang.not_enough_point")?>';
</script>
<script src="/assets/js/basic.js?ver=97"></script>
<script src="/assets/js/check_news.js?ver=97"></script>
<script src="/assets/js/quest.js?ver=97"></script>
<script>
