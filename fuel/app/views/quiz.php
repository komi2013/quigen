...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/quiz.css?ver=85" />
...
<?php if( isset($_GET['iframe']) ){?>
    <link rel="stylesheet" href="/assets/css/sp.css?ver=85">
<?php }else{ ?>
...
<script src="/assets/js/check_news.js?ver=85"></script>
<script src="/assets/js/quiz.js?ver=85"></script>
<script>
setTimeout(function(){
