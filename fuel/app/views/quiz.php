...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/quiz.css?ver=91" />
...
<?php if( isset($_GET['iframe']) ){?>
    <link rel="stylesheet" href="/assets/css/sp.css?ver=91">
<?php }else{ ?>
...
<script src="/assets/js/quiz.js?ver=91"></script>
<script>
setTimeout(function(){
