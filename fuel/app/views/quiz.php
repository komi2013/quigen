...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/quiz.css?ver=54" />
...
<?php if( isset($_GET['iframe']) ){?>
    <link rel="stylesheet" href="/assets/css/sp.css?ver=54">
<?php }else{ ?>
...
<script src="/assets/js/quiz.js?ver=54"></script>
<script>
setTimeout(function(){
