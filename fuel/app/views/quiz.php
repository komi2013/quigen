...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/quiz.css?ver=94" />
...
<?php if( isset($_GET['iframe']) ){?>
    <link rel="stylesheet" href="/assets/css/sp.css?ver=94">
<?php }else{ ?>
...
<script src="/assets/js/quiz.js?ver=94"></script>
<script>
setTimeout(function(){
